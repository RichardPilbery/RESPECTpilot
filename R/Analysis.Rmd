...
pathToWinbugsApp <- 'ENTER PATH TO WinBUGS14 DIRECTORY HERE'
lockBinding("pathToWinbugsApp", globalenv())

pathToWinbugsIncorrect <- 'ENTER PATH TO winBUGS-incorrect DIRECTORY HERE'
lockBinding("pathToWinbugsIncorrect", globalenv())
pathToWinbugsCorrect <- 'ENTER PATH TO winBUGS-correct DIRECTORY HERE'
lockBinding("pathToWinbugsCorrect", globalenv())

pathToWine <- 'ENTER PATH TO wine HERE'
lockBinding("pathToWine", globalenv())
pathToWinePath <- 'ENTER PATH TO winepath HERE'
lockBinding("pathToWinePath", globalenv())
...
#bugsTestI <- bugs(data=c("FSD99CI.txt"), inits=c("inits.txt","inits.txt","inits.txt"), parameters.to.save=c("beta","ecg","sds","sde"), model.file = "model.txt",program=c("WinBUGS"),n.chains = 3,n.iter = 1000000,n.burnin=6000,n.thin=5,digits=5, useWINE=TRUE,bugs.directory = pathToWinbugsApp, working.directory = pathToWinbugsIncorrect, WINE=pathToWine,WINEPATH=pathToWinePath ,debug=F,DIC=T,codaPkg=TRUE)

#bugsTestC <- bugs(data=c("FSD99CC.txt"), inits=c("inits.txt","inits.txt","inits.txt"), parameters.to.save=c("beta","ecg","sds","sde"), model.file = "model.txt",program=c("WinBUGS"),n.chains = 3,n.iter = 1000000,n.burnin=6000,n.thin=5,digits=5, useWINE=TRUE,bugs.directory = pathToWinbugsApp, working.directory = pathToWinbugsCorrect, WINE=pathToWine,WINEPATH=pathToWinePath ,debug=F,DIC=T,codaPkg=TRUE)
